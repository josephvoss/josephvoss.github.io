...
of our cluster, and learned about Linux system management and control. My main tasks were running and tuning High Performance Linpack, writing scripts to automatically 
build, run, and generate matplotlib graphs analysing the performance of several 
...
Novemeber 11th, we will fly out to Salt Lake City for the Super Computing Conference 
...
During my Mechanical Engineering Computational Methods class the proffessor explained 
...
actual hardware on an FPGA board. After desiging a basic adder and instruction set, 
and defining a simple assembly language to use to perform basic operations, I started 
breadboarding the FPGA with small static RAM chips to serve as external memory. While 
...
issues prevented this from becoming a usuable device. The screen used was to small to 
